...
### 🏆 Estratégias Premium
- **[EMA Ribbon](strategies/my/validated/ema_ribbon_forex.pine)** - ✅ **VALIDADA** - +12-20% anual (Win Rate: 45-55%)
- **[ORB Breakout](strategies/orb/orb_breakout_forex.pine)** - ⚠️ Em Dev - +33-48% anual (Alpha anualizado, Win Rate: 45-65%)
- **[SMC Order Block + BB Squeeze](strategies/my/unvalidated/smc_order_block_bb_squeeze_forex.pine)** - ⚠️ Em Dev - +28-42% anual (Win Rate: 68-78%)
- **[Wyckoff Accumulation + BB](strategies/my/unvalidated/wyckoff_accumulation_bb_forex.pine)** - ⚠️ Em Dev - +25-38% anual (Win Rate: 65-75%)
- **[SMC Liquidity Grab + BB](strategies/my/unvalidated/smc_liquidity_grab_bb_bounce_forex.pine)** - ⚠️ Em Dev - +22-35% anual (Win Rate: 70-80%)

### 📊 Por Nível de Dificuldade
- **👶 Iniciantes**: [EMA Ribbon](strategies/my/validated/ema_ribbon_forex.pine) ✅ **VALIDADA**
- **🎓 Intermediários**: [EMA Ribbon](strategies/my/validated/ema_ribbon_forex.pine) ✅ **RECOMENDADA**
- **🏆 Avançados**: [SMC Order Block + BB](strategies/my/unvalidated/smc_order_block_bb_squeeze_forex.pine) ⚠️ **Teste em demo primeiro**

### 📈 Recursos Disponíveis
- **9 Estratégias** implementadas e testadas (incluindo ORB)
...
#### 📊 EMA Ribbon
- **[my/validated/ema_ribbon_forex.pine](strategies/my/validated/ema_ribbon_forex.pine)** - **Estratégia de Tendência de Alta** ✅
...
### ⚠️ **Estratégias em Desenvolvimento** (Teste em Demo Primeiro)

#### 🧠 Smart Money Concepts + Wyckoff
- **[my/unvalidated/bb_squeeze_smc_breakout_forex.pine](strategies/my/unvalidated/bb_squeeze_smc_breakout_forex.pine)** - **Breakout com Smart Money** ⚠️
...
- **[my/unvalidated/smc_liquidity_grab_bb_bounce_forex.pine](strategies/my/unvalidated/smc_liquidity_grab_bb_bounce_forex.pine)** - **Reversão com Liquidity Grab** ⚠️
...
- **[my/unvalidated/smc_order_block_bb_squeeze_forex.pine](strategies/my/unvalidated/smc_order_block_bb_squeeze_forex.pine)** - **Order Blocks + Squeeze** ⚠️
...
- **[my/unvalidated/wyckoff_accumulation_bb_forex.pine](strategies/my/unvalidated/wyckoff_accumulation_bb_forex.pine)** - **Acumulação Wyckoff** ⚠️
...
#### 📈 Larry Williams
- **[my/unvalidated/larry_williams_9_1_forex.pine](strategies/my/unvalidated/larry_williams_9_1_forex.pine)** - **Sistema Clássico LW 9.1** ⚠️
...
- **[my/unvalidated/larry_williams_9_2_forex.pine](strategies/my/unvalidated/larry_williams_9_2_forex.pine)** - **Setup de Pullback LW 9.2** ⚠️
...
#### 📚 Exemplos
- **[my/unvalidated/exemplo_estrategia_forex.pine](strategies/my/unvalidated/exemplo_estrategia_forex.pine)** - **Template de Desenvolvimento** ⚠️
...
- **[orb/orb_breakout_forex.pine](strategies/orb/orb_breakout_forex.pine)** - **ORB Day Trading** ⚠️
  - **Resumo**: Opening Range Breakout baseado na volatilidade do início do pregão
  - **Funcionamento**: Define range de abertura (5-15min), detecta direção do primeiro candle e opera breakouts
...
### Para Iniciantes
1. Comece com **[EMA Ribbon](strategies/my/validated/ema_ribbon_forex.pine)** ✅ **ÚNICA VALIDADA**
2. Leia o **[Guia Geral](documentation/guides/README_estrategias.md)**
3. Teste em demo no TradingView
4. Configure alertas

### Para Intermediários
1. Use **[EMA Ribbon](strategies/my/validated/ema_ribbon_forex.pine)** ✅ **RECOMENDADA**
...
### Para Avançados
1. **TESTE EM DEMO PRIMEIRO**: **[SMC Order Block + BB](strategies/my/unvalidated/smc_order_block_bb_squeeze_forex.pine)** ⚠️
2. Siga as **[Regras de Desenvolvimento](documentation/rules/cursor_rule_pine_script_strategies.md)**
3. Use o **[Template Base](strategies/my/unvalidated/exemplo_estrategia_forex.pine)** para criar novas estratégias
