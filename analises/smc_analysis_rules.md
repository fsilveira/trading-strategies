# REGRAS DE ANÁLISE SMC (SMART MONEY CONCEPT)
...
### **Confluências Avançadas (Opcionais)**
- **Elliott Wave**: Identifica fases de impulso e correção
  - **Onda 3**: Melhor para entradas SMC
  - **Onda 5**: Cuidado com divergências
  - **Correções**: A, B, C para timing
- **Wyckoff**: Fases de acumulação e distribuição
  - **Spring**: Quebra falsa (trap) - confirma Order Block
  - **Test**: Teste secundário - valida suporte/resistência
  - **Jump**: Sinal de força - confirma BOS
  - **Sign of Strength**: Confirmação de tendência

### **Como Usar Confluências (NÃO Obrigatório)**
- **Prioridade 1**: SMC (Order Blocks, FVG, BOS, CHoCH)
- **Prioridade 2**: Confluências técnicas (Fibonacci, Support/Resistance)
- **Prioridade 3**: Elliott/Wyckoff (apenas se claramente identificáveis)
- **Regra**: Nunca force interpretações - se não estiver claro, ignore
...
## 8. FORMATO DE APRESENTAÇÃO VISUAL

### **Estrutura da Análise**
- Use tabelas para organizar informações
- Destaque dados importantes com emojis e cores
...
- **Tabelas**: Organize dados em colunas claras
- **Status**: ✅ Presente, ❌ Ausente, ⚠️ Atenção
- **Força**: ⭐ (1-3 estrelas)
- **Cores**: 🟢 Verde (bullish), 🔴 Vermelho (bearish), 🟡 Amarelo (neutro)

### **Métricas Quantificáveis**
- Preços específicos para entrada, stop e targets
